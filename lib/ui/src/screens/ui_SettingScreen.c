...
lv_obj_set_style_text_font(ui_canh1, &lv_font_montserrat_22, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_text_font(ui_canh2, &lv_font_montserrat_22, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_text_font(ui_canh3, &lv_font_montserrat_22, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_text_font(ui_canh4, &lv_font_montserrat_22, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_text_font(ui_canh5, &lv_font_montserrat_22, LV_PART_MAIN| LV_STATE_DEFAULT);
