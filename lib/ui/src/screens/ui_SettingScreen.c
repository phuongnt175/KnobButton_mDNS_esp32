...
void ui_SettingScreen_screen_init(void)
{
    ...
    lv_obj_set_width(ui_scene1, 150);
    lv_obj_set_height(ui_scene1, 150);
    lv_obj_set_x(ui_scene1, 80);
    lv_obj_set_y(ui_scene1, 70);
    lv_obj_add_flag(ui_scene1, LV_OBJ_FLAG_HIDDEN);     /// Flags
    lv_obj_clear_flag(ui_scene1, LV_OBJ_FLAG_PRESS_LOCK | LV_OBJ_FLAG_CLICK_FOCUSABLE | LV_OBJ_FLAG_GESTURE_BUBBLE |
                      LV_OBJ_FLAG_SNAPPABLE | LV_OBJ_FLAG_SCROLLABLE | LV_OBJ_FLAG_SCROLL_ELASTIC | LV_OBJ_FLAG_SCROLL_MOMENTUM |
                      LV_OBJ_FLAG_SCROLL_CHAIN | LV_OBJ_FLAG_CLICKABLE);     /// Flags
    ...
    lv_obj_set_width(ui_scene2, 150);
    lv_obj_set_height(ui_scene2, 150);
    lv_obj_set_x(ui_scene2, -80);
    lv_obj_set_y(ui_scene2, 70);
    lv_obj_set_align(ui_scene2, LV_ALIGN_TOP_RIGHT);
    lv_obj_add_flag(ui_scene2, LV_OBJ_FLAG_HIDDEN);     /// Flags
    lv_obj_clear_flag(ui_scene2, LV_OBJ_FLAG_PRESS_LOCK | LV_OBJ_FLAG_CLICK_FOCUSABLE | LV_OBJ_FLAG_GESTURE_BUBBLE |
                      LV_OBJ_FLAG_SNAPPABLE | LV_OBJ_FLAG_SCROLLABLE | LV_OBJ_FLAG_SCROLL_ELASTIC | LV_OBJ_FLAG_SCROLL_MOMENTUM |
                      LV_OBJ_FLAG_SCROLL_CHAIN | LV_OBJ_FLAG_CLICKABLE);     /// Flags
    ...
    lv_obj_set_width(ui_scene3, 150);
    lv_obj_set_height(ui_scene3, 150);
    lv_obj_set_x(ui_scene3, 80);
    lv_obj_set_y(ui_scene3, -70);
    lv_obj_set_align(ui_scene3, LV_ALIGN_BOTTOM_LEFT);
    lv_obj_add_flag(ui_scene3, LV_OBJ_FLAG_HIDDEN);     /// Flags
    lv_obj_clear_flag(ui_scene3, LV_OBJ_FLAG_PRESS_LOCK | LV_OBJ_FLAG_CLICK_FOCUSABLE | LV_OBJ_FLAG_GESTURE_BUBBLE |
                      LV_OBJ_FLAG_SNAPPABLE | LV_OBJ_FLAG_SCROLLABLE | LV_OBJ_FLAG_SCROLL_ELASTIC | LV_OBJ_FLAG_SCROLL_MOMENTUM |
                      LV_OBJ_FLAG_SCROLL_CHAIN | LV_OBJ_FLAG_CLICKABLE);     /// Flags
    ...
    lv_obj_set_width(ui_scene4, 150);
    lv_obj_set_height(ui_scene4, 150);
    lv_obj_set_x(ui_scene4, -80);
    lv_obj_set_y(ui_scene4, -70);
    lv_obj_set_align(ui_scene4, LV_ALIGN_BOTTOM_RIGHT);
    lv_obj_add_flag(ui_scene4, LV_OBJ_FLAG_HIDDEN);     /// Flags
    lv_obj_clear_flag(ui_scene4, LV_OBJ_FLAG_PRESS_LOCK | LV_OBJ_FLAG_CLICK_FOCUSABLE | LV_OBJ_FLAG_GESTURE_BUBBLE |
                      LV_OBJ_FLAG_SNAPPABLE | LV_OBJ_FLAG_SCROLLABLE | LV_OBJ_FLAG_SCROLL_ELASTIC | LV_OBJ_FLAG_SCROLL_MOMENTUM |
                      LV_OBJ_FLAG_SCROLL_CHAIN | LV_OBJ_FLAG_CLICKABLE);     /// Flags
    ...
    lv_obj_set_y(ui_back, 190);
    lv_obj_set_align(ui_back, LV_ALIGN_CENTER);
    lv_obj_clear_flag(ui_back, LV_OBJ_FLAG_PRESS_LOCK | LV_OBJ_FLAG_CLICK_FOCUSABLE | LV_OBJ_FLAG_GESTURE_BUBBLE |
                      LV_OBJ_FLAG_SNAPPABLE | LV_OBJ_FLAG_SCROLLABLE | LV_OBJ_FLAG_SCROLL_ELASTIC | LV_OBJ_FLAG_SCROLL_MOMENTUM |
